...
app.delete('/diplomacias/:id_1/:id_2', DiploController.deleteDiplo)
//Pjreino
...
app.get('/top5personajesConMasFuerza', PjController.PjFuertes5)
app.get('/personajeConMasKarts',PjController.KartsMas)
